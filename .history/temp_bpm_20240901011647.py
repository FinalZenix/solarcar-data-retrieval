...
def bms_getWarnInfo(bms):
    ...
    try:
        ...
        for pack_index in range(1,packs+1):
            ...
            if debug_output > 0:
                print("Pack " + str(pack_index).zfill(config['zero_pad_number_packs']) + ", warnings: " + warnings)
                print("Pack " + str(pack_index).zfill(config['zero_pad_number_packs']) + ", balancing1: " + balanceState1)
                print("Pack " + str(pack_index).zfill(config['zero_pad_number_packs']) + ", balancing2: " + balanceState2)
