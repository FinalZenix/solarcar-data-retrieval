...
def bms_connect():
    ...
    raise Exception("Unable to connect to the BMS")
...
def bms_data_collection():
    ...
    try:
        ...
        logging.warning("Could not connect to the BMS. Closing Thread ...")
...
def tb_communication():
    ...
    while True:
        if error_connection:
            logger.warning("There is no BMS connected at the moment. Closing thread ...")
            return
        try:
...
if __name__ == "__main__":
    ...
    try:
        ...
        logger.warn("Could not Connect to BMS")
